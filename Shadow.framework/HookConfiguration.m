...
static const SHDWPlugin kSHDWPlugins[] = {
    ...
    { "Hook_DeviceSecurityKit", SHDWDetectorPatchDeviceSecurityKitID, SHDWPhaseAlways,      SHDWCapabilityMessage,     1, 0 },
...
NSDictionary<NSString*, id>* SHDWDefaultHookSettings(void) {
    return @{
        ...
        SHDWDetectorPatchDeviceSecurityKitID : @(YES),
...
NSDictionary<NSString*, id>* SHDWPresetMaximum(void) {
    ...
    preset[SHDWDetectorPatchDeviceSecurityKitID] = @(YES);
    return preset;
}
