...
* IOSSecuritySuite 2.3.0, DTTJailbreakDetection `cedd424`, freeRASP 7.1.2, dyldprobe
...
* **JailMonkey** `master@rn` — RN bridge (Cydia/Substrate/bash, FileManager, cydia:// + sileo://, /private write, dyld) — ObjC, iOS 11+
