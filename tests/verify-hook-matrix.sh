...
# ([private-harness-path] = $PRIVATE_HT, default tests/). Public runs skip them; the private
...
# public checkout), so its "[private-harness-path] path keeps the public spelling.
