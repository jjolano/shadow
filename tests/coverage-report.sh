...
report DpkgRulesGenerator.m "writeDpkgRuleset" "writeDpkgRuleset" "shdw -g"
report RestrictionEngine.m "isPathRestrictedQuery" "isPathRestrictedQuery" "path engine"
report RestrictionEngine.m "isSchemeRestricted" "isSchemeRestricted" "scheme engine"
report RestrictionEngine.m "isBundleIDRestricted" "isBundleIDRestricted" "bundle-id engine"
report RulesetStore.m "checkForChanges" "checkForChanges" "reload path"
