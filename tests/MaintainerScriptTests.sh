...
harness_frameworks="$harness_pkg/Applications/[private-harness].app/Frameworks"
...
env SHADOW_HARNESS_DPKG_ROOT="$harness_pkg" sh "$root/tests/[private-harness]/layout/DEBIAN/postinst" configure
