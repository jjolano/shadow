...
final class AppDelegate: UIResponder, UIApplicationDelegate {
  private static let wasJBKey = "f18b0c9bb06bedcd4e9e84b3a2d878c6c526d3fe4ac3ca70c03c95f80cc24298"
  var window: UIWindow?
  private var callback: String?
  private var finished = false
  private var wasJBBefore = false
  ...
  private func finish() {
    ...
    let sent = runnerFinish("freerasp", "freeRASP", "7.1.2", outcome,
      ...
      ["allChecksFinished": state.finished, "wasjbBefore": wasJBBefore,
       "wasjbAfter": UserDefaults.standard.object(forKey: Self.wasJBKey) != nil,
       "genericProbe": genericProbe], callback)
    if !sent { exit(1) }
  }
  ...
  private func start(_ url: URL) {
    ...
    callback = value
    wasJBBefore = UserDefaults.standard.object(forKey: Self.wasJBKey) != nil
